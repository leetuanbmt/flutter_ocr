...
// Define OCRResult struct here
struct OCRResult {
    std::vector<std::vector<std::vector<int>>> boxes;  // Bounding boxes for text
    std::vector<std::string> texts;  // Recognized text
...
public:
  ...
  OCRResult Process_val(std::string savedImagePath);
